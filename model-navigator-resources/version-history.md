...
* Upates CDE versions for the properties `study_age_group`, `image_type_included`, `sex`, `tumor_grade`, `tissue_category`, `data_file_format`.  These properties have their permissible values changed.
